...
,
		"rect" : [ 63.0, 104.0, 812.0, 517.0 ],
		"bgcolor" : [ 0.447059, 0.643137, 0.376471, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 83.0, 329.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 93.0, 358.0, 111.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 392.0, 128.0, 32.0 ],
					"saturation" : 0.270588
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 441.0, 127.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 310.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 14.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 446.0, 77.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "random 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 423.0, 44.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "metro 300"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 423.0, 119.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 532.0, 175.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "random 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 423.0, 175.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "random 700"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 248.0, 206.0, 22.0 ],
					"style" : "",
					"text" : "sprintf presentation_rect %i %i 40 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 426.0, 380.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 227.0, 43.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 281.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "why?"
				}
